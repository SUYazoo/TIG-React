  ...
  const restaurants = [
    {
        ...
        icon: require('../assets/boat-app/desGascons_icon.png'),
        img: require('../assets/boat-app/desGascons@3x.png'),
    ...
    },
    {
        ...
        icon: require('../assets/boat-app/fousDeLIle_icon@3x.png'),
        img: require('../assets/boat-app/fousDeLIle@3x.png'),
        description: 'Un restaurant typique de 10h à 21h tous les jours pour une ambiance chaleureuse entre amis.'
    },
    {
        id : 3,
        nom: 'Bistrot Landais',
        icon: require('../assets/boat-app/bistrotLandais_icon@3x.png'),
        img: require('../assets/boat-app/bistrotLandais@3x.png'),
        description: 'Restaurant de cuisine traditionnelle Landaise, spécialisée dans les plats du Sud-Ouest...'
    },
    {
        id : 4,
        nom: 'Villa 9-Trois',
        icon: require('../assets/boat-app/villa9Trois_icon@3x.png'),
        img: require('../assets/boat-app/villa9Trois_icon@3x.png'),
        description: 'Restaurant de cuisine traditionnelle Landaise, spécialisée dans les plats du Sud-Ouest...'
    },
]
    ...
    const headerComponent = () => {
        return <Text style={styles.listHeadline}>Selection d'un restaurant</Text>
    }
